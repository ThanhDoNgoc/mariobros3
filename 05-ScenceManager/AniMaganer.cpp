...
AniMaganer* AniMaganer::__instance = NULL;

AniMaganer::AniMaganer()
{
}
...
void AniMaganer::_ParseSection_TEXTURES(string line)
{
...
void AniMaganer::_ParseSection_SPRITES(string line)
{
	vector<string> tokens = split(line);
...
AniMaganer* AniMaganer::GetInstance()
{
	if (__instance == NULL) __instance = new AniMaganer();
	return __instance;
}
