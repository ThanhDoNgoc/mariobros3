...
MusicNode::MusicNode()
{
	AddAnimation(ID_ANI_MUSIC_NOTE);
	ObjectGroup = Group::musicblock;
...
void MusicNode::GetBoundingBox(float& l, float& t, float& r, float& b)
{
	l = x;
	t = y;
...
void MusicNode::Update(DWORD dt, vector<LPGAMEOBJECT>* coObjects)
{
...
void MusicNode::OnOverLap(CGameObject* obj)
{
